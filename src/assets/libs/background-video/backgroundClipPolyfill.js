...
var element1 = document.querySelector('.title-1'); 
var element2 = document.querySelector('.title-2'); 
var element3 = document.querySelector('.title-3'); 
 ...
 */
element1.backgroundClipPolyfill({
  'patternID' : 'mypattern',
  'patternURL' : 'http://timpietrusky.com/cdn/army.png',
  'class' : 'title-1'
});

element2.backgroundClipPolyfill({
  'patternID' : 'mypattern',
  'patternURL' : 'http://timpietrusky.com/cdn/army.png',
  'class' : 'title-2'
});

element3.backgroundClipPolyfill({
  'patternID' : 'mypattern',
  'patternURL' : 'http://timpietrusky.com/cdn/army.png',
  'class' : 'title-3'
});